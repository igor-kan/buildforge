# Contributing to buildforge

Thank you for your interest in contributing to buildforge! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/buildforge.git
   cd buildforge
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/buildforge.git
   ```
...
By contributing to buildforge, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
